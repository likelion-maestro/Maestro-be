...
public class CorsConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry){
        registry.addMapping("/**")  // 프로그램에서 제공하는 URL
                .allowedOrigins("http://localhost:3000", "localhost:3000", "https://localhost:3000", "https://maestrometronome.netlify.app/", "http://maestrometronome.netlify.app/", "https://maestrometronome.netlify.app/:3000", "http://maestrometronome.netlify.app/:3000", "maestrometronome.netlify.app/:3000", "maestrometronome.netlify.app") // 클라이언트 주소. 어떤 출처들을 허용할 것인지
